...
const data = [
  { name: "2022", value: 300, color: "#2a84ff" },
  { name: "2023", value: 300, color: "#9cc5ff" },
  { name: "2024", value: 400, color: "#d5e7ff" },
];

const OrderAnalysticsGraphs = () => {
  return (
          ...
          <div className="application-dashboard-graph d-flex flex-column flex-sm-row gap-4 align-items-center">
            <div>
              <div className="application-dashboard-title">
                <h2 className="card-title text-start mb-2">Order Analytics</h2>
              </div>
              <div
...
export default OrderAnalysticsGraphs;
