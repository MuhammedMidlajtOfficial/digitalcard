...
import { AllUsersTableList } from "../UserManagement/ViewAllUsers/AllUsersTableList";
...
import UsersCards from "../UserManagement/ViewAllUsers/UsersCards";
...
const EmployeeLIst = () => {
  ...
  // currently fetching from users data
  const fetchUsers = () => {
